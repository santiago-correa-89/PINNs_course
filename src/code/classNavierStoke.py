...
class NavierStoke:
    ...
    def __init__(self, XdataTrain, UdataTrain, Xphisic, Xtest, Utest, layers, lr, Re, alpha, folder, nIterAdam, niterLBFGS):
...
# Defining variables
    ...
    model = NavierStoke(XdataTrain, UdataTrain, Xphisic, Xtest, Utest, layers, lr, Re, alpha, folder, nIterAdam, niterLBFGS)